...
void State_AcTest::calcTau(){
    ...
    if (count%5 == 0)
    {
        ...
        _pub->pub_data_movement(_posBody, _pcd, _velBody, _vCmdGlobal, _lowState->getAccGlobal(), _ddPcd, mm, _d_mb, _posError, _velError);
