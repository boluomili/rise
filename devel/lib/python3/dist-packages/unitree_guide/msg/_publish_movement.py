...
class publish_movement(genpy.Message):
  _md5sum = "b88b531e00b4da435dd84b50acfed86a"
...
float64 d_mp"""
  __slots__ = ['p','p_d','err_p','v','v_d','err_v','a','a_d','sumfootforce','d_mp']
  _slot_types = ['float64[3]','float64[3]','float64[3]','float64[3]','float64[3]','float64[3]','float64[3]','float64[3]','float64','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       p,p_d,err_p,v,v_d,err_v,a,a_d,sumfootforce,d_mp
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2d().pack(_x.sumfootforce, _x.d_mp))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.sumfootforce, _x.d_mp,) = _get_struct_2d().unpack(str[start:end])
      return self
